            ...
            <div className='flex flex-col gap-4 w-full lg:py-6 lg:px-24 md:p-8 p-4'>
                  ...
                  <div className="w-full flex flex-col md:flex-row items-center gap-4">
                        <div className="md:w-1/2 w-full flex flex-col items-center justify-center gap-8">
                              ...
                              <Link to='https://drive.google.com/file/d/1ZbWL6kLluGbuSKuhAEIe9Zdxcdq6Tm04/view?usp=sharing' target="_blank" className='md:px-12 px-4 py-3 border-2 border-primary rounded-lg md:text-lg text-md text-primary bg-bg2 hover:bg-primary hover:text-bg2 hover:border-bg2 transition duration-500 ease-linear font-semibold'>Dowload CV</Link>
                        </div>
